...
# CSRF tokeni için ayarlar
CSRF_COOKIE_NAME = 'csrftoken'  # CSRF çerezi adı
CSRF_HEADER_NAME = 'HTTP_X_CSRFTOKEN'  # CSRF tokeni için HTTP başlık adı

# CSRF kullanımı hakkında ayarlar
CSRF_USE_SESSIONS = False  # CSRF tokeni saklamak için session kullanılacak mı?
CSRF_COOKIE_HTTPONLY = False  # CSRF çerezi sadece HTTP üzerinden erişilebilir olsun mu?
CSRF_COOKIE_SECURE = False  # CSRF çerezi yalnızca HTTPS üzerinden gönderilsin mi?
